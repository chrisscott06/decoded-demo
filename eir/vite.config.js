...
export default defineConfig({
  ...
  server: {
    // Demo runs on 5174 to avoid colliding with the source production
    // project on 5173. strictPort so it fails loudly if 5174 is already
    // in use rather than silently roaming to a different number.
    port: 5174,
    strictPort: true,
